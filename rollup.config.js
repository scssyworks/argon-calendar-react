...
esmConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/esm/argonCalendarReact.esm.js',
    format: 'esm'
});
esmConfig.plugins = [
...
esmProdConfig.output = Object.assign({}, esmConfig.output, {
    file: 'dist/esm/argonCalendarReact.esm.min.js',
    sourcemap: false
});
...
umdConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/umd/argonCalendarReact.js',
    format: 'umd'
});
umdConfig.plugins = [
    ...commonConfig.plugins,
...
umdProdConfig.output = Object.assign({}, umdConfig.output, {
    file: 'dist/umd/argonCalendarReact.min.js',
    sourcemap: false
});
...
if (process.env.SERVE) {
    ...
    serveConfig.output = Object.assign({}, commonConfig.output, {
        file: 'dist/render/argonCalendarReact.iife.js',
        format: 'iife'
    });
    serveConfig.plugins = [
        eslint({
